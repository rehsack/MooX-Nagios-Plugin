package MooseX::Nagios::Plugin::Fetch::MongoBySnmp;
...
with 'MooseX::Nagios::Plugin::Fetch::BySnmp';
...
sub _mongo_plugin_match
{
    my $self = shift;
    my $port =
      $self->_mongo_instance_port(
                                $self->has_mongo_instance ? $self->mongo_instance : "replica_set" );
